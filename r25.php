...
<body style=" background-color: #ABE2FF;">
		<div style="height:110px ;
					...
					<h1>	
					<center>¿Quién es este reconocido escritor colombiano? </center>
					<h1>
					
		
			<form style="margin-left: 100px;" method="POST">

		<input type="submit" name="v73" value="GRABIEL GARCIA MARQUEZ" class="v3">

	
	<input type="submit" name="v74" value="EDGAR ALLAN POE" class="v3">

		
		<input type="submit" name="v75" value="JUANITO ESPINOSA LOZANO" class="v3">
			</form>	

														<br><br>
				<div style="margin-left: -200px; margin-top: -50PX;">
			<img src="p27.jpeg" class="img">	
								</div>
