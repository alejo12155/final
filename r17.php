...
<body style=" background-color: #ABE2FF;">
		<div style="height:110px ;
					...
					<h1>	
					<center>¿Qué tratado dio fin a la Guerra de los Mil Días?</center>
					<h1>
					
		
			<form style="margin-left: 100px;" method="POST">

		<input type="submit" name="v49" value="EL TRATADO DE PAZ DE WISCONSIN" class="v3">

	
	<input type="submit" name="v50" value="TRATADO CONTRA LAS FUERZAS ARMADAS" class="v3">

		
		<input type="submit" name="v51" value="DIALOGO POR LA NUEVA NORMA" class="v3">
			</form>	

														<br><br>
				<div style="margin-left: -200px; margin-top: -50PX;">
			<img src="p17.jpeg" class="img">	
								</div>
