...
<body style=" background-color: #ABE2FF;">
		<div style="height:110px ;
					...
					<h1>	
					<center>¿Como se llama esta estructura? </center>
					<h1>
					
		
			<form style="margin-left: 100px;" method="POST">

		<input type="submit" name="v37" value="SANTUARIO DE LAS LAJAS" class="v3">
 
	
	<input type="submit" name="v38" value="SANTUARIO BLANCO" class="v3">

		
		<input type="submit" name="v39" value="DISTRITO BENITO" class="v3">
			</form>	

														<br><br>
				<div style="margin-left: -200px; margin-top: -50PX;">
			<img src="p13.jpeg " class="img">	
						</div>
